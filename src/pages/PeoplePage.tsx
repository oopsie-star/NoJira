    ...
    <GlobalLayout>
      <div className="space-y-6 p-6">
        <section className="rounded-[28px] bg-white p-6 shadow-sm">
          ...
          <h1 className="mt-1 text-3xl font-semibold text-slate-900">{t('people.title')}</h1>
          ...
          <>
            ...
            <section className="overflow-hidden rounded-[28px] bg-white shadow-sm">
              {projectMembers.length === 0 ? (
                ...
                <>
                  <div className="grid grid-cols-[1.2fr_180px_1fr_1fr_180px] gap-4 border-b border-slate-200 bg-slate-50 px-5 py-4 text-xs font-semibold uppercase tracking-[0.12em] text-slate-500">
                  ...
                  {projectMembers.map((member) => {
                    ...
                    return (
                      <div key={member.id} className="grid grid-cols-[1.2fr_180px_1fr_1fr_180px] items-center gap-4 border-b border-slate-200 px-5 py-4 last:border-b-0">
